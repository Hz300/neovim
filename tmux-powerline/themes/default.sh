...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info  #b2b439 234"
		#"mode_indicator 165 0"
		"vcs_branch #e8d8c9 black"
		#"vcs_compare 60 255"
		#"vcs_staged 64 255"
		#"vcs_modified 9 255"
		#"vcs_others 245 0"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"xkb_layout 125 117"
		"date_day 235 #4b607f"
		"date 235 #4b607f ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"time 235 #4b607f ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
